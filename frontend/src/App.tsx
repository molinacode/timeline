...
const SearchPage = lazy(() =>
  import('./features/news/SearchPage').then((m) => ({ default: m.SearchPage }))
)
const InterestsOnboardingPage = lazy(() =>
  import('./features/user/InterestsOnboardingPage').then((m) => ({ default: m.InterestsOnboardingPage }))
)
const ListsListPage = lazy(() =>
  import('./features/user/lists/ListsListPage').then((m) => ({ default: m.ListsListPage }))
)
const ListCreatePage = lazy(() =>
  import('./features/user/lists/ListCreatePage').then((m) => ({ default: m.ListCreatePage }))
)
const ListDetailPage = lazy(() =>
  import('./features/user/lists/ListDetailPage').then((m) => ({ default: m.ListDetailPage }))
)
const SavedNewsPage = lazy(() =>
  import('./features/user/SavedNewsPage').then((m) => ({ default: m.SavedNewsPage }))
)
