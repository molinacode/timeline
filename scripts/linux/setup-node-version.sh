#!/usr/bin/env bash
# Configurar Node.js 20.18.0 con nvm (Linux)
# Ejecutar: ./scripts/linux/setup-node-version.sh
...
# Cargar nvm (rutas típicas en Linux)
...
if [ -s "$NVM_DIR/nvm.sh" ]; then
  ...
  echo "   Instálalo con: curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.40.1/install.sh | bash"
